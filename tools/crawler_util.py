...
def safe_int(value, default: int = 0) -> int:
    """Parse API numeric fields; treat placeholders like '--' as missing."""
    if value is None:
        return default
...
async def get_working_page(browser_context: BrowserContext) -> Page:
    """Reuse the visible CDP tab instead of opening a hidden second tab."""
