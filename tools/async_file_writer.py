...
class AsyncFileWriter:
    ...
    def _get_file_path(self, file_type: str, item_type: str) -> str:
        ...
        if config.ENABLE_VIDEO_FOLDER_SPLIT and config.SAVE_DATA_PATH:
            base_path = config.SAVE_DATA_PATH
            file_name = f"{item_type}_{date_str}.{file_type}"
        elif config.SAVE_DATA_PATH:
            base_path = f"{config.SAVE_DATA_PATH}/{self.platform}/{file_type}"
            file_name = f"{self.crawler_type}_{item_type}_{date_str}.{file_type}"
        else:
